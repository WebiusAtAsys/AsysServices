...
#adding static to urls if in debug
...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='usersApp/login.html'), name="login"), #template_name argument tells django where to look for the template
    ...
    path('configure/', include('configApp.urls')),
    path('statistics/', include('statApp.urls')),
